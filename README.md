...
| scientificDomains.scientificDomain | nan | string Vocabulary ScientificDomains | 1 | M |  |
| scientificDomains.scientificSubdomain | nan | string Vocabulary ScientificSubDomains | 1 | M |  |
| categories | nan | list of objects | 1 | R |  |
| categories.category | nan | string Vocabulary ServiceCategory | 1 | M |  |
| categories.subcategory | nan | string Vocabulary Service SubCategory | 1 | M |  |
...
| persistentIdentitySystems.persistentIdentityProductType | Specify the ProductType to which the persistent identifier is referring to. | Vocabulary: Research Product Type | 1 | M |  |
| persistentIdentitySystems.persistentIdentityProductTypeScheme | Specify the list of persistent identifier schemes used to refer to other research-related entities (e.g., authors, organizations, etc.) | List. each value from Vocabulary: Persistent Identity Scheme | N | M |  |
...
| creator.role | Role of the person in the context of this entity | String Vocabulary Credit Taxonomy | 1 | O |  |
